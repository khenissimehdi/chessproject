...
class KnightTest {
	...
	public void isValidMoveTest() {
		...
		pieces[1][2] = null;
		assertEquals(true,pieces[0][0].moveTo(pieces[1][2].getPosition()));
	}
	@Test
	public void isNotValidMoveTest() {
		...
		pieces[0][0] = new Knight(board, new Position(0, 0), Color.WHITE);
		pieces[0][1] = null;
		assertEquals(false,pieces[0][0].moveTo(pieces[0][1].getPosition()));
	}
	@Test
	public void isNotValidMoveWhiteVSWhiteTest() {
		...
		assertEquals(false,pieces[0][0].moveTo(pieces[1][2].getPosition()));
	}
	@Test
